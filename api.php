    ...
    if ($xml->error_code != '') {
        ...
        <div align="center">
            ...
            <div id="insert_box_button">
                ...
                <br/><br/>
                <input name="insert2" type="button" onclick="insert_large_tbn()"
                       value="Large thumbnail w/ link to original"/>
                <br/><br/>
                <input name="insert3" type="button" onclick="insert_small_tbn()"
                       value="Small thumbnail w/ link to original"/>
